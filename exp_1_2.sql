...
select Sname from S where Sno in(
	select Sno from SC,C where SC.Cno=C.Cno and Cname='数据库' and Grade=(
		select max(Grade) from SC,C where SC.Cno=C.Cno and Cname='数据库' and Grade<>(
			select max(Grade) from SC,C where SC.Cno=C.Cno and Cname='数据库')));
